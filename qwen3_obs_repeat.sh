...
accelerate launch \
    ...
    --do_train \
    --dataset new_webshop_repeat_obs_train \
    --eval_dataset new_webshop_repeat_obs_val \
    --template qwen \
    --finetuning_type full \
    --output_dir saves/qwen3_8b-memory/repeat_obs_4gpu_lr1e-5 \
    --overwrite_cache \
    ...
    --trust_remote_code \
    --report_to wandb \
    --run_name qwen3_8b_memory_repeat_obs_4gpu_lr1e-5 \
