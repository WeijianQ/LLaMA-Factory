...
#SBATCH --job-name=qwen3_8b_memory_text_current_obs_4gpu
#SBATCH --output=logs/qwen3_8b_memory_text_current_obs_4gpu_%j.out
#SBATCH --error=logs/qwen3_8b_memory_text_current_obs_4gpu_%j.err
...
WANDB_NOTES="freeze llm, train memory module, text current obs, fsdp"
...
accelerate launch \
    ...
    --output_dir saves/qwen3_8b-memory/freeze_llm_text_obs_memory_lr1e-3 \
    --overwrite_cache \
    ...
    --trust_remote_code \
    --report_to wandb \
    --run_name qwen3_8b_freeze_llm_memory_lr1e-3 \
